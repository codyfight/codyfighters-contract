...
contract CKey is ERC721, ERC721URIStorage, Pausable, Ownable {
    ...
    event CCoinDeposited(uint256 indexed tokenId, uint256 amount);
    event CCoinWithdrawn(uint256 indexed tokenId, uint256 amount);
    event CTicketDeposited(uint256 indexed tokenId, uint256 amount);
    event CTicketWithdrawn(uint256 indexed tokenId, uint256 amount);
    ...
    function depositCCoin(uint256 tokenId, uint256 amount) external {
        ...
        emit CCoinDeposited(tokenId, amount);
    }
    ...
    function withdrawCCoin(uint256 tokenId, uint256 amount) external {
        ...
        emit CCoinWithdrawn(tokenId, amount);
    }
    ...
    function depositCTicket(uint256 tokenId, uint256 amount) external {
        ...
        emit CTicketDeposited(tokenId, amount);
    }
    ...
    function withdrawCTicket(uint256 tokenId, uint256 amount) external {
        ...
        emit CTicketWithdrawn(tokenId, amount);
    }
